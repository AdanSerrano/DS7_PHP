...
class video extends soporte
{
    ...
    public function imprime_caracteristicas()
    {
        ...
        parent::imprime_caracteristicas(); // Llama al método de la clase base
    ...
    public function imprime_jugadores_posibles()
    {
        if ($this->min_num_jugadores == $this->max_num_jugadores) {
            if ($this->min_num_jugadores == 1)
                ...
                return "Para " . $this->min_num_jugadores . " jugadores";
        } else {
            return "De " . $this->min_num_jugadores . " a " . $this->max_num_jugadores . " jugadores.";
        }
    }
}
